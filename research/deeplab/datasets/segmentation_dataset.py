...
_DEEPFASHION2_INFORMATION = DatasetDescriptor(
    splits_to_sizes={
        'train': 184283,
	'trainval':7678,
        'val': 32152,
...
_MODANET2_INFORMATION = DatasetDescriptor(
    splits_to_sizes={
        'train_full': 39236, # 39128
        'valid_full':2636, # 2608
        'test_full': 10380, # 10515
    },
    num_classes=20, # num_classes=14,
    ignore_label = 255
)
...
_DATASETS_INFORMATION = {
    'deepfashion2': _DEEPFASHION2_INFORMATION,
    'pascal_voc_seg': _PASCAL_VOC_SEG_INFORMATION,
    'ade20k': _ADE20K_INFORMATION,
    'modanet2': _MODANET2_INFORMATION
}
