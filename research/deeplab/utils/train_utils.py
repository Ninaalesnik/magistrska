...
def add_softmax_cross_entropy_loss_for_each_scale(scales_to_logits,
  ...
  for scale, logits in six.iteritems(scales_to_logits):
    ...
    weight_label18 =999
    weight_label19 = 998
    not_ignore_mask =tf.to_float(tf.equal(scaled_labels,0)) *weight_label0 + tf.to_float(tf.equal(scaled_labels,1)) * weight_label1 + tf.to_float(tf.equal(scaled_labels,2)) * weight_label2 + tf.to_float(tf.equal(scaled_labels,3)) * weight_label3 + tf.to_float(tf.equal(scaled_labels,4)) * weight_label4 + tf.to_float(tf.equal(scaled_labels,5)) * weight_label5 + tf.to_float(tf.equal(scaled_labels,6)) * weight_label6 + tf.to_float(tf.equal(scaled_labels,7)) * weight_label7 + tf.to_float(tf.equal(scaled_labels,8)) * weight_label8 + tf.to_float(tf.equal(scaled_labels,9)) * weight_label9 + tf.to_float(tf.equal(scaled_labels,10)) * weight_label10 + tf.to_float(tf.equal(scaled_labels,11)) * weight_label11 + tf.to_float(tf.equal(scaled_labels,12)) * weight_label12 + tf.to_float(tf.equal(scaled_labels,13)) * weight_label13 + tf.to_float(tf.equal(scaled_labels,14)) * weight_label14 + tf.to_float(tf.equal(scaled_labels,15)) * weight_label15 + tf.to_float(tf.equal(scaled_labels,16)) * weight_label16 + tf.to_float(tf.equal(scaled_labels,17)) * weight_label17 + tf.to_float(tf.equal(scaled_labels,18)) * weight_label18 + tf.to_float(tf.equal(scaled_labels,19)) * weight_label19+ tf.to_float(tf.equal(scaled_labels, ignore_label)) * 0 
...
def get_model_init_fn(train_logdir,
  ...
  """Gets the function initializing model variables from a checkpoint.
    ...
    weight_label12 = 999
    weight_label13 = 997
        not_ignore_mask =tf.to_float(tf.equal(scaled_labels,0)) *weight_label0 + tf.to_float(tf.equal(scaled_labels,1)) * weight_label1 + tf.to_float(tf.equal(scaled_labels,2)) * weight_label2 + tf.to_float(tf.equal(scaled_labels,3)) * weight_label3 + tf.to_float(tf.equal(scaled_labels,4)) * weight_label4 + tf.to_float(tf.equal(scaled_labels,5)) * weight_label5 + tf.to_float(tf.equal(scaled_labels,6)) * weight_label6 + tf.to_float(tf.equal(scaled_labels,7)) * weight_label7 + tf.to_float(tf.equal(scaled_labels,8)) * weight_label8 + tf.to_float(tf.equal(scaled_labels,9)) * weight_label9 + tf.to_float(tf.equal(scaled_labels,10)) * weight_label10 + tf.to_float(tf.equal(scaled_labels,11)) * weight_label11 + tf.to_float(tf.equal(scaled_labels,12)) * weight_label12 + tf.to_float(tf.equal(scaled_labels,13)) * weight_label13 + tf.to_float(tf.equal(scaled_labels, ignore_label)) * 0 
