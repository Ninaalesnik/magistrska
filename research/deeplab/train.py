...
flags.DEFINE_integer('training_number_of_steps', 35000000,
...
flags.DEFINE_list('train_crop_size', '400,¸600',
...
# Dataset settings.
flags.DEFINE_string('dataset', 'modanet',
...
#    	fd.write(global_step + "=" + total_loss)
    print(total_loss)	
